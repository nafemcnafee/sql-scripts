/*
File: Nafe_McNafee_Assgn2.sql
Author: Nafe McNafee
Description: This script inserts customer data to Specialty Imports DataBase 
*/ 
/*Inserting three new customer data into the CUSTOMER table*/
INSERT INTO customer(cname, cstreet, ccity, cprov, cpostal, cbphone)
...
INSERT INTO car(serial#, cname, make, model, cyear, color, trim, enginetype, purchinv, purchdate, purchfrom, purchcost, freight, totalcost, listprice)
...
INSERT INTO saleinvoice(inv#, cname, salesman, saledate, serial#, totalprice,discount, net, tax, licfee, commission, tradeserial#, tradeallow, fire, collision, liability, property)
...
INSERT INTO invoption(inv#, ocode, saleprice)
...
INSERT INTO serviceinvoice(servinv#, servdate, cname, serial#, partscost, laborcost, tax, totalcost)
...
INSERT INTO servicework(servinv#, workdescription)
